...
const Products = () => {
      ...
      <ul className="menu-slide">
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="submenu">
            ...
            <li><a href="http://wpkixx.com/html/Grah Laxmi Sahbhagi/development-component.html" title>Components</a></li>
          </ul>
        </li>
      </ul>
    </nav>{/* sidebar */}
  ...
  {/* Mirrored from wpkixx.com/html/Grah Laxmi Sahbhagi-panel/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 11:15:36 GMT */}
</div>
    </>
  )
}
