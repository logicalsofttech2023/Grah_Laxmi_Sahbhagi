  ...
  <div className="theme-layout">
    ...
    <header className>
      <div className="topbar stick">
        <div className="logo"><img alt src="images/logo.png" /><span>Grah Laxmi Sahbhagi</span></div>
 ...
 <Link to={"/login"}>
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="submenu">
            ...
            <li><a href="http://wpkixx.com/html/Grah Laxmi Sahbhagi/development-elements.html" title>Elements</a></li>
            <li><a href="http://wpkixx.com/html/Grah Laxmi Sahbhagi/development-component.html" title>Components</a>
            </li>
          </ul>
        </li>
      </ul>
                  ...
                  <div className="d-widget-content">
                    <div className="violetion-message">
                      <p>
                        ...
                        Report about the sex content violation of Grah Laxmi Sahbhagi
                        <a className="button soft-danger circle" href="#" title>Take Action</a>
                      </p>
                      <p>
                        <i className="icofont-info-circle" />
                        Report about abuse violation of Grah Laxmi Sahbhagi
                        <a className="button soft-danger circle" href="#" title>Take Action</a>
                      </p>
                    </div>
                  </div>
  ...
  {/* Mirrored from wpkixx.com/html/Grah Laxmi Sahbhagi-panel/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 11:15:29 GMT */}
</div>
</>
  )
}
